...
// }
 ...
 const Loly:React.FC<any> = ({ top , middle , bottom }) => {
    return(
        <>
  ...
  <g id="Page-2" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
    <g id="Lolly">
      ...
      <use className="bottom" fill={bottom} fillRule="nonzero" xlinkHref="#path-1" />
      <rect className="top" fill={top} fillRule="nonzero" mask="url(#mask-2)" x={-25} y={-9} width={224} height={134} />
      <rect className="middle" fill={middle} fillRule="nonzero" mask="url(#mask-2)" x={-29} y={113} width={224} height={111} />
